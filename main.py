...
def reset_timer():
    ...
    title_label.config(text="Timer", fg=GREEN, font=(FONT_NAME, 50, "bold"), bg=YELLOW)
...
def count_down(count):
    ...
    if count > 0:
        global timer
        timer = window.after(1000, count_down, count - 1)  # count-1 will be the parameter of the count_down function
    else:
        start_timer()
        checks = ""
